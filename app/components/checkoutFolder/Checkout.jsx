...
// import { IoHome, IoChevronDown, IoChevronUp } from "react-icons/io5"; // For icons

// const Checkout = () => {
//   // Access the correct properties from the Redux state
//   const cart = useSelector((state) => state.cart); 
//   const cartItems = cart?.cartItems || []; // Use cartItems instead of items
//   const totalAmount = cart?.totalAmount || 0;

//   // Debugging: Log the cart and cartItems to ensure correct state access
//   useEffect(() => {
...
//   const [showOrderSummary, setShowOrderSummary] = useState(false); // Toggle for order summary dropdown
...
//           <div className="font-semibold text-xl mt-2 -mb-2">Delivery</div>
//           <div className="mt-4">
//             <IoHome />
//           </div>
//         </div>
...
//         {/* Shipping Method */}
//         <div className="font-bold text-xl mt-2 -mb-2">Shipping Method</div>
...
//         {/* Payments */}
//         <div className="font-bold text-xl mt-2 -mb-2">Payments</div>
...
//         />
//         <span className="absolute -top-2 -right-2 bg-black bg-opacity-50 text-white text-[10px] font-bold rounded-full h-4 w-4 flex items-center justify-center">
//                 {item.quantity}
//               </span>
//         </div>
...
//             <div>Sub Total </div>
//             <div className="">Rs. {totalAmount}</div>
//           </div>
...
//         <button
//           type="submit"
//           className="p-3 bg-black text-white rounded hover:bg-gray-600 mt-4 w-full"
//         >
//           Complete Order
//         </button>
//       </form>
      ...
      <div className="max-w-4xl mx-auto">
        <form className="grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4 p-4 md:py-6 md:pr-2 md:pl-6">
            ...
            <div className="flex justify-start items-center gap-2" >
              <label htmlFor="email" className="block text-lg font-playfair font-semibold">
                Contact
              </label>
